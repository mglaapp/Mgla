...
- **account** Подписка и оплата в приложении (2b22f0a)
...
- **lint** Сторож мёртвых файлов молчал на Windows (163909f)

## v0.9.1 (2026-09-13)

**Features**

- **brand** Свой знак вместо апстримовского (83e4dd0)
- **profiles** Подписка по ключу доступа (04f2a1d)
- **ui** Состояние подключения тремя признаками (ca2e4e8)

**Bug Fixes**

- **brand** Исходники трея тоже нашим знаком (93daacc)
