...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accessNotPaid": MessageLookupByLibrary.simpleMessage("未払いです"),
    "accessPaidUntil": MessageLookupByLibrary.simpleMessage("有効期限"),
    "account": MessageLookupByLibrary.simpleMessage("アカウント"),
    "accountCreated": MessageLookupByLibrary.simpleMessage("アカウントを作成しました"),
    "accountCreatedTip": MessageLookupByLibrary.simpleMessage(
      "ログインリンクを保存してください。これがないと別の端末からサイトにログインできません。アプリの接続は使えますが、サイトへのログインはできなくなります。",
    ),
    ...
    "bindEmail": MessageLookupByLibrary.simpleMessage("メールアドレスを紐づける"),
    "bindTelegram": MessageLookupByLibrary.simpleMessage("Telegram を紐づける"),
    ...
    "getSubscription": MessageLookupByLibrary.simpleMessage("サブスクリプションを購入"),
    ...
    "letterSent": MessageLookupByLibrary.simpleMessage("メールを送信しました"),
    ...
    "loginLinkTitle": MessageLookupByLibrary.simpleMessage("ログインリンク"),
    "loginLinkWarning": MessageLookupByLibrary.simpleMessage(
      "このリンクはパスワードと同じです。開いた人は誰でもあなたのアカウントにログインできます。チャットで送ったり、どこかに公開したりしないでください。パスワードと同じように保管してください。",
    ),
    ...
    "paymentReceived": MessageLookupByLibrary.simpleMessage("支払いを確認しました"),
    ...
    "recoverAccess": MessageLookupByLibrary.simpleMessage("アクセスを取り戻す方法"),
    "recoverAccessTip": MessageLookupByLibrary.simpleMessage(
      "アカウントはこのアプリの中にあります。メールアドレスか Telegram を紐づけてください。そうしないと、別の端末から有料アクセスを取り戻す手段がありません。",
    ),
    ...
    "showLink": MessageLookupByLibrary.simpleMessage("リンクを表示"),
