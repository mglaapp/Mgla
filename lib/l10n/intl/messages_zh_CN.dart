...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(code) =>
      "Windows 拒绝运行 FlClashCore.exe（错误 ${code}）。智能应用控制、AppLocker 等应用控制策略会拦截未签名程序，请在该策略中放行 Mgla 或关闭策略后重试。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accessNotPaid": MessageLookupByLibrary.simpleMessage("尚未付费"),
    "accessPaidUntil": MessageLookupByLibrary.simpleMessage("有效期至"),
    "account": MessageLookupByLibrary.simpleMessage("账号"),
    "accountCreated": MessageLookupByLibrary.simpleMessage("账户已创建"),
    "accountCreatedTip": MessageLookupByLibrary.simpleMessage(
      "请保存登录链接。没有它就无法在其他设备上登录网站：应用内的连接仍可使用，但网站登录不行。",
    ),
    ...
    "bindEmail": MessageLookupByLibrary.simpleMessage("绑定邮箱"),
    "bindTelegram": MessageLookupByLibrary.simpleMessage("绑定 Telegram"),
    ...
    "coreBlockedBySmartAppControlTip": MessageLookupByLibrary.simpleMessage(
      "Windows 智能应用控制拦截了未签名的 FlClashCore.exe。请打开 Windows 安全中心 → 应用和浏览器控制 → 智能应用控制设置，选择「关闭」后重新启动 Mgla。智能应用控制关闭后无法再开启，除非重装 Windows。",
    ),
    ...
    "getSubscription": MessageLookupByLibrary.simpleMessage("购买订阅"),
    ...
    "letterSent": MessageLookupByLibrary.simpleMessage("邮件已发送"),
    ...
    "loginLinkTitle": MessageLookupByLibrary.simpleMessage("登录链接"),
    "loginLinkWarning": MessageLookupByLibrary.simpleMessage(
      "这个链接等同于密码：任何打开它的人都能登录你的账户。不要在聊天中发送，也不要公开发布。请像保管密码一样保管它。",
    ),
    ...
    "paymentReceived": MessageLookupByLibrary.simpleMessage("已收到付款"),
    ...
    "recoverAccess": MessageLookupByLibrary.simpleMessage("如何找回访问权限"),
    "recoverAccessTip": MessageLookupByLibrary.simpleMessage(
      "账户保存在这个应用里。请绑定邮箱或 Telegram，否则在其他设备上将无法找回已付费的访问权限。",
    ),
    ...
    "showLink": MessageLookupByLibrary.simpleMessage("显示链接"),
