...
void main() {
  ...
  group('LinuxProtocolRegistrationPlan', () {
    ...
    test('writes a hidden desktop entry claiming every scheme', () {
      expect(
        plan.desktopPath,
        '/home/me/.local/share/applications/mgla-url-handler.desktop',
      );
      expect(
        plan.desktopEntry,
        '[Desktop Entry]\n'
        ...
        'MimeType=x-scheme-handler/mgla;x-scheme-handler/clash;'
        'x-scheme-handler/clashmeta;x-scheme-handler/flclash;\n',
      );
    });
    ...
    test('makes the entry the default handler for every scheme', () {
      expect(plan.xdgMimeArguments, [
        'default',
        'mgla-url-handler.desktop',
        'x-scheme-handler/mgla',
